...
function initAutocomplete(chosenEmotion) {
  map = new google.maps.Map(document.getElementById('map'), {
    ...
    center: {lat: 53.469512, lng: -2.2235535},
    zoom: 12,
         styles: [
...
var heatmapData = [
  new google.maps.LatLng(53.469512,-2.2235535),
  new google.maps.LatLng(55, -2.2245),
  new google.maps.LatLng(55, -2.224),
  new google.maps.LatLng(55, -2.26),
  new google.maps.LatLng(55, -3.8)]
